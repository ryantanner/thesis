...
public class EnglishGrammaticalRelations {
  ...
  // todo Add analysis for content clause complements to noun: The news that Bush is dead OR The rule that banks can't fail
  ...
  private static final String copularWordRegex =
    "/^(am|is|are|be|being|Being|'s|'re|'m|was|were|been|seem|seems|seemed|appear|appears|appeared|stay|stays|stayed|remain|remains|remained|resemble|resembles|resembled|become|becomes|became)$/";
  ...
  public static final GrammaticalRelation CONJUNCT =
    new GrammaticalRelation(Language.English, "conj", "conjunct",
        ...
        new String[] { // remember conjunction can be left or right headed....
          ...
          "VP|ADJP|PP|QP|NP|ADVP|UCP|S|NX|SBAR < (CC|CONJP $- __ $+ !/^(?:PRN|,)$/=target) !<, CC",
          // non-parenthetical or comma in suitable phrase with conj then adverb to left
          "VP|ADJP|PP|NP|ADVP|UCP|S|NX|SBAR < (CC|CONJP $- __ $+ (ADVP $+ !/^(?:PRN|,)$/=target))",
          // content phrase to the right of a comma or a parenthetical
          "VP|ADJP|PP|NP|ADVP|UCP|S|NX|SBAR < (CC|CONJP $- __) < (/^(?:,|PRN)$/ $+ /^S$|^(A|N|V|PP|PRP|J|W|R)/=target)",
          ...
          "VP|ADJP|PP|QP|NP|ADVP|UCP|S|NX|SBAR < (CC $++ (CC|CONJP $+ !/^(?:PRN|,)$/=target))"
        });
  ...
  public static final GrammaticalRelation DIRECT_OBJECT =
    new GrammaticalRelation(Language.English, "dobj", "direct object",
        ...
        new String[] {
          ...
          "SBARQ <, (WHNP=target !< WRB) <+(SQ|SINV|S|VP) (VP !< (S < (VP < TO)) !< (/^VB|AUX?/ < " + copularWordRegex + " !$++ (VP < VBG)) !<- PRT !<- (PP <: IN) $-- (NP !< /^-NONE-$/))",  // this pattern used to assume no empty NPs. Corrected.
          ...
          "SBAR !< (WHPP|WHNP) < (S < (NP $+ (VP !<(/^VB|AUXG?/ < " + copularWordRegex + " !$+ VP) !<+(VP) NP !< SBAR !<+(VP) (PP <- IN)))) $-- NP > NP=target",
          "SBAR !< (WHPP|WHNP) < (S < (NP $+ (ADVP $+ (VP !<(/^VB|AUXG?/ < " + copularWordRegex + " !$+VP) !<+(VP) NP !< SBAR !<+(VP) (PP <- IN))))) $-- NP > NP=target"
  ...
  public static final GrammaticalRelation PREPOSITIONAL_OBJECT =
    new GrammaticalRelation(Language.English, "pobj", "prepositional object",
        ...
        new String[] {
          ...
          // to deal with preposition stranding in questions (e.g., "Which city do you live in?") -- the preposition is sometimes treated at a particle by the parser (works well but doesn't preserve the tree structure!)
         ...
         "(PP <- IN) >> (SBAR !< (WHPP|WHNP) < (S < (NP $+ (VP !<(/^VB|AUXG?/ < " + copularWordRegex + " !$+ VP) !<+(VP) NP !< SBAR ))) $-- NP > NP=target)",
  ...
  public static final GrammaticalRelation ATTRIBUTIVE =
    new GrammaticalRelation(Language.English, "attr", "attributive",
        ...
        new String[] {
          ...
          // "What is that?"
          "SBARQ < (WHNP=target $+ (SQ < (/^VB|AUX?/ < /^(am|is|are|'s|'re|'m|was|were|seem|seems|seemed|appear|appears|appeared|stay|stays|stayed|remain|remains|remained|resemble|resembles|resembled|become|becomes|became)$/ !$++ VP) !< (VP <- (PP <:IN)) !<- (PP <: IN)))",
          "SBARQ <, (WHNP=target !< WRB) <+(SQ|SINV|S|VP) (VP !< (S < (VP < TO)) < (/^VB|AUX?/ < " + copularWordRegex + " !$++ (VP < VBG)) !<- PRT !<- (PP <: IN) $-- (NP !< /^-NONE-$/))",
          //"Is he the man?"
   ...
   * a verb, adjective is a dependent clause with an internal subject which
  ...
  public static final GrammaticalRelation COMPLEMENTIZER =
    new GrammaticalRelation(Language.English, "complm", "complementizer",
        ...
        new String[] {
          ...
          "SBAR <, (IN|DT=target < /^(?:that|whether)$/) $- NP|NN|NNS",
  ...
  public static final GrammaticalRelation TEMPORAL_MODIFIER =
    new GrammaticalRelation(Language.English, "tmod", "temporal modifier",
        TemporalModifierGRAnnotation.class, MODIFIER, "VP|S|ADJP|PP",
        new String[] {
          "VP|ADJP < /^NP-TMP$/=target",
          "VP|ADJP < (NP=target < (/^NN/ < " + timeWordRegex + "))",
  ...
  public static final GrammaticalRelation PREPOSITIONAL_MODIFIER =
    new GrammaticalRelation(Language.English, "prep", "prepositional modifier",
        PrepositionalModifierGRAnnotation.class, MODIFIER, "NP(?:-TMP|-ADV)?|WHNP|VP|S|SINV|ADJP|SBARQ|NAC",
        new String[] {
          "/^NP(?:-TMP|-ADV)?|WHNP|VP|ADJP|NAC$/ < /^(?:WH)?PP(?:-TMP)?$/=target",
