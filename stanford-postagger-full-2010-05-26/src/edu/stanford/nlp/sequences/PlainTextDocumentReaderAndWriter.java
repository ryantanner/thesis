...
public class PlainTextDocumentReaderAndWriter implements DocumentReaderAndWriter {
  ...
  // todo: This is hardwired for PTBTokenizer, and hence languages roughly like English.  There should be flags which would allow it to be used with other languages/tokenizers, perhaps instead involving changes in CRFClassifier, etc.
