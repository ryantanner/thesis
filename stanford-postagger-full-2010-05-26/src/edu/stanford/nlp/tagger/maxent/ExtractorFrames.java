  ...
  protected static Extractor[] getExtractorFrames(String arch) {
    ...
    for (String arg : args) {
      if (arg.equals("bidirectional")) {
        ...
        // cdm 2009: We only add successively higher tag k-grams
        // ending at prev.  Adding lower order features at a distance
        // appears not to help (Dec 2009)
        // TODO: why not get rid of this and then get rid of the
        // "suppress warnings" above
        switch (order) {
          case 3:
