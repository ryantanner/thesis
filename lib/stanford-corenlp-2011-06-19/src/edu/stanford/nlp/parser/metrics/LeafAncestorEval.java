...
//TODO wsg: Add separate category for faulty chains that arise from POS tagging errors
...
public class LeafAncestorEval {
  ...
  private static int MAX_GUESS_YIELD = Integer.MAX_VALUE;
  private static boolean skipGuess = false;
  ...
  public static void main(String[] args) {
    ...
    final LeafAncestorEval depEval = new LeafAncestorEval("Stand Alone");
