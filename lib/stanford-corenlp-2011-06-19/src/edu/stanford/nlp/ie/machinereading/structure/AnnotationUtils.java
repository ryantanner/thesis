...
import edu.stanford.nlp.ie.machinereading.RelationMentionFactory;
...
public class AnnotationUtils {
  ...
  public static List<CoreLabel> sentenceEntityMentionsToCoreLabels(
      ...
      boolean useBIO) {
    /*
    Tree completeTree = sentence.get(CoreAnnotations.TreeAnnotation.class);
  ...
  public static Annotation sentenceDeepMentionCopy(Annotation sentence) {
    ...
    newSent.set(CoreAnnotations.TreeAnnotation.class, sentence.get(TreeAnnotation.class));
    ...
    newSent.set(MachineReadingAnnotations.DocumentIdAnnotation.class, sentence.get(MachineReadingAnnotations.DocumentIdAnnotation.class));
