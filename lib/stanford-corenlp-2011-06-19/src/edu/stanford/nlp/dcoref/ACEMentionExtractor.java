...
public class ACEMentionExtractor extends MentionExtractor {
  ...
  private static Logger logger = SieveCoreferenceSystem.logger;
  ...
  public ACEMentionExtractor(LexicalizedParser p, Dictionaries dict, Properties props, Semantics semantics) throws Exception {    
