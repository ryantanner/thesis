...
public class Document implements Serializable {
  ...
  protected List<List<Mention>> goldOrderedMentionsBySentence;
  /** The list of predicted mentions */
  protected List<List<Mention>> predictedOrderedMentionsBySentence;
  ...
  protected void extractGoldCorefClusters(){
