...
public class TaggerConfig extends Properties /* Inherits implementation of serializable! */ {
  ...
  ITERATIONS = "100",
  ARCH = "",
  RARE_WORD_THRESH = String.valueOf(MaxentTagger.RARE_WORD_THRESH),
  MIN_FEATURE_THRESH = String.valueOf(MaxentTagger.MIN_FEATURE_THRESH),
  CUR_WORD_MIN_FEATURE_THRESH = String.valueOf(MaxentTagger.CUR_WORD_MIN_FEATURE_THRESH),
  RARE_WORD_MIN_FEATURE_THRESH = String.valueOf(MaxentTagger.RARE_WORD_MIN_FEATURE_THRESH),
  VERY_COMMON_WORD_THRESH = String.valueOf(MaxentTagger.VERY_COMMON_WORD_THRESH),
  OCCURING_TAGS_ONLY = String.valueOf(MaxentTagger.OCCURRING_TAGS_ONLY),
  POSSIBLE_TAGS_ONLY = String.valueOf(MaxentTagger.POSSIBLE_TAGS_ONLY),
  ...
  public static final String getDefaultTagSeparator() { return TAG_SEPARATOR; }
  ...
  private static void printGenProps() {
    ...
    System.out.println("# A couple flags for controlling the amount of output:");
    System.out.println("# - print extra debugging information:");
    System.out.println("# verbose = " + VERBOSE);
    System.out.println("# - print intermediate results:");
    System.out.println("# verboseResults = " + VERBOSE_RESULTS);
