...
THING = ([dDoOlL]{APOSETCETERA}[A-Za-z0-9])?[A-Za-z0-9]+([_-]([dDoOlL]{APOSETCETERA}[A-Za-z0-9])?[A-Za-z0-9]+)*
...
ABSTATE = Ala|Ariz|Ark|Calif|Colo|Conn|Dak|Del|Fla|Ga|Ill|Ind|Kans?|Ky|La|Mass|Md|Mich|Minn|Miss|Mo|Mont|Neb|Nev|Okla|Ore|Pa|Penn|Tenn|Tex|Va|Vt|Wash|Wisc?|Wyo
ACRO = [A-Za-z](\.[A-Za-z])+|(Canada|Sino|Korean|EU|Japan|non)-U\.S|U\.S\.-(U\.K|U\.S\.S\.R)
ABTITLE = Mr|Mrs|Ms|Miss|Drs?|Profs?|Sens?|Reps?|Attys?|Lt|Col|Gen|Messrs|Govs?|Adm|Rev|Maj|Sgt|Cpl|Pvt|Mt|Capt|Ste?|Ave|Pres|Lieut|Hon|Brig|Co?mdr|Pfc|Spc|Supts?|Det
ABPTIT = Jr|Sr|Bros|Ph\.D|Blvd|Rd|Esq
ABCOMP = Inc|Cos?|Corp|Pty|Ltd|Plc|Bancorp|Dept|M[ft]g|Bhd|Assn|Univ|Intl|Sys|Natl|Elec
...
ABBREV4	= [A-Za-z]|{ABTITLE}|vs|Alex|Wm|Jos|Cie|a\.k\.a|cf|TREAS|{ACRO}
ABBREV2	= {ABBREV4}\.
ACRONYM = ({ACRO})\.
...
{ACRONYM}/{SPACE}([A]bout|[A]ccording|[A]dditionally|[A]fter|[A]n|[A]|[A]s|[A]t|[B]ut|[E]arlier|[H]e|[H]er|[H]ere|[H]owever|[I]f|[I]n|[I]t|[L]ast|[M]any|[M]ore|[M]r\.|[M]s\.|[N]ow|[O]nce|[O]ne|[O]ther|[O]ur|[S]he|[S]ince|[S]o|[S]ome|[S]uch|[T]hat|[T]he|[T]hen|[T]here|[T]hese|[T]hey|[T]his|[W]e|[W]hen|[W]hile|[W]hat|[Y]et|[Y]ou){SPACE} {
                          String s = yytext();
