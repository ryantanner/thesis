...
public class Options implements Serializable {
  ...
  private int setOptionFlag(String[] args, int i) {
    if (args[i].equalsIgnoreCase("-PCFG")) {
      ...
      Train.ruleSmoothing = true;
      Train.ruleSmoothingAlpha = Double.valueOf(args[i+1]);
      i += 2;
...
//      Train.markovOrder = 2;
      ...
      Train.selectiveSplit = true;
      Train.selectiveSplitCutOff = 300.0;
      Train.markUnary = 0; //Unary rule marking bad for french..setting to 0 gives +0.3 F1
