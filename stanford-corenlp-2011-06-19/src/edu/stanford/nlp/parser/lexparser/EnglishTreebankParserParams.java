...
public class EnglishTreebankParserParams extends AbstractTreebankParserParams {
  ...
  public TreeReaderFactory treeReaderFactory() {
    return new TreeReaderFactory() {
      public TreeReader newTreeReader(Reader in) {
        return new PennTreeReader(in, new LabeledScoredTreeFactory(), new NPTmpRetainingTreeNormalizer(EnglishTrain.splitTMP, EnglishTrain.splitSGapped == 5, Train.leaveItAll, EnglishTrain.splitNPADV >= 1, headFinder()));
      }
    };
  }
  ...
  public static class EnglishTrain {
     ...
     */
    public static int makePPTOintoIN = 0;
