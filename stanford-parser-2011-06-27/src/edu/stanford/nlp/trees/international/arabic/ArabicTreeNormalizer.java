...
public class ArabicTreeNormalizer extends BobChrisTreeNormalizer {
  ...
  public String normalizeTerminal(String leaf) {
    if(!changeNoLabels && !leaf.contains(MorphoFeatureSpecification.MORPHO_MARK))
  ...
  public Tree normalizeWholeTree(Tree tree, TreeFactory tf) {
    ...
    for (Tree t : tree) {
      ...
      if(t.isLeaf()) {
        //Strip off morphological analyses and place them in the CurrentAnnotation, which is
