...
public class ArabicTreebankParserParams extends AbstractTreebankParserParams {
  ...
  public ArabicTreebankParserParams() {
    ...
    activeAnnotations = new HashMap<TregexPattern,Function<TregexMatcher,String>>();
  ...
  public Lexicon lex() {
    if(morphoSpec != null)
      return new FactoredLexicon(morphoSpec);
  ...
  public Lexicon lex(Options.LexOptions op) {
    ...
    if(morphoSpec != null)
      return new FactoredLexicon(op,morphoSpec);
  ...
  public Tree transformTree(Tree t, Tree root) {
    ...
    if(t.isPreTerminal() && morphoSpec != null) {
      ...
      MorphoFeatures feats = morphoSpec.strToFeatures(morphoStr);
   ...
   */
  private static final List<String> baselineFeatures = new ArrayList<String>();
  static {
    baselineFeatures.add("-discardX");
  ...
  private static final List<String> additionalFeatures = new ArrayList<String>();
  ...
  private void initializeAnnotationPatterns() {
    ...
    try {
      ...
      //MWE specific patterns
      annotationPatterns.put("-MWV", new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("/VB/ > @MWV"), new SimpleStringFunction("-mwv")));
      annotationPatterns.put("-MWP", new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("@IN > @MWP"), new SimpleStringFunction("-mwp")));
  ...
  private void removeBaselineFeature(String featName) {
    if(baselineFeatures.contains(featName)) {
      ...
      activeAnnotations.remove(p.first());
    }
  }
  ...
  public int setOptionFlag(String[] args, int i) {
    ...
    if (annotationPatterns.keySet().contains(args[i])) {
      ...
      optionsString.append("Added MWE annotations (-MWV,-MWP)\n");
