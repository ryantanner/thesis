...
public class FrenchTreebankParserParams extends AbstractTreebankParserParams {
  ...
  private void initializeAnnotationPatterns() {
    try {
      ...
      annotationPatterns.put("-splitPUNC",new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("@PUNC < __=punc"),new AnnotatePunctuationFunction("-","punc")));
  ...
  private static class AddPOSSequenceFunction implements SerializableFunction<TregexMatcher,String> {
