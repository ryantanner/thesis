...
public class Test {
   ...
   */
  public static String outputFilesExtension = "stp";

  /**
   * If the writeOutputFiles option is true, then output files appear with
   * this prefix.
   */
  public static String outputFilesPrefix = "parses";
  ...
  /**
   * When you want to force the parser to parse a particular subsequence
   ...
   * the state Pattern given.  See the documentation of the Constraint class
   * for information on specifying a Constraint.
   */
  ...
  public static class Constraint implements Serializable {
    ...
    public Constraint(int start, int end, Pattern state) {
      this.start = start;
      this.end = end;
      this.state = state;
    }
